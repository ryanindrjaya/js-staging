...
module.exports = __webpack_require__("Xk2e");
...
// CONCATENATED MODULE: ./components/ReactDataTable/SupplierTable.js
...
// CONCATENATED MODULE: ./pages/dashboard/supplier/index.js
...
const Supplier = ({
  ...
  const handleDelete = async id => {
    ...
    if (res) {
      ...
      const res = await req.json();
      external_react_toastify_["toast"].success("Supplier berhasil dihapus");
      setSupplier(res);
    }
  };
...
/* harmony default export */ var dashboard_supplier = __webpack_exports__["default"] = (Supplier);
