...
module.exports = __webpack_require__("DlbC");
...
// CONCATENATED MODULE: ./components/ReactDataTable/UserTable.js
...
function ReactDataTable({
  ...
  const columns = [{
    ...
    selector: row => {
      ...
      return (_row$role = row.role) === null || _row$role === void 0 ? void 0 : _row$role.name;
    }
  }, {
    name: "Tindakan",
    width: "250px",
    selector: row => /*#__PURE__*/Object(jsx_runtime_["jsx"])(jsx_runtime_["Fragment"], {
      children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
        ...
        children: [row.deleteAble ? /*#__PURE__*/Object(jsx_runtime_["jsx"])("button", {
          ...
          children: "Edit"
        }), row.deleteAble ? /*#__PURE__*/Object(jsx_runtime_["jsx"])(Alert["a" /* default */], {
          onCancel: onCancel,
          onConfirm: onConfirm,
          title: "Hapus User",
          ...
          className: "invisible",
          children: /*#__PURE__*/Object(jsx_runtime_["jsx"])("button", {
            className: "hover:bg-cyan-400  hover:text-white transition-colors  text-xs font-normal py-2 px-2 rounded-md ",
            children: "Hapus"
          })
        })]
      })
...
// CONCATENATED MODULE: ./pages/dashboard/pengguna/index.js
...
const Pengguna = ({
  ...
  const handleDelete = async id => {
    ...
    if (res) {
      ...
      external_react_toastify_["toast"].success("Data Pengguna berhasil dihapus");
      setUser(data);
    }
  };
...
/* harmony default export */ var pengguna = __webpack_exports__["default"] = (Pengguna);
