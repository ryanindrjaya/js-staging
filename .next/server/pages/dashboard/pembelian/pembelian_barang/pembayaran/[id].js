...
// CONCATENATED MODULE: ./components/ReactDataTable/Purchases/PurchasingPaymentTable.js
...
function ReactDataTable({
  ...
  const getProductDisc = row => {
    ...
    for (let index = 1; index < 6; index++) {
      ...
      var unitProduct = (_row$attributes2 = row.attributes) === null || _row$attributes2 === void 0 ? void 0 : _row$attributes2.product.data.attributes[`unit_${index}`];
      var unitOrder = row.attributes.unit_order;

      if (unitProduct === unitOrder) {
        var _row$attributes3, _row$attributes4, _row$attributes5;

        disc1 = (_row$attributes3 = row.attributes) === null || _row$attributes3 === void 0 ? void 0 : _row$attributes3.product.data.attributes[`unit_${index}_dp1`];
        disc2 = (_row$attributes4 = row.attributes) === null || _row$attributes4 === void 0 ? void 0 : _row$attributes4.product.data.attributes[`unit_${index}_dp2`];
        disc3 = (_row$attributes5 = row.attributes) === null || _row$attributes5 === void 0 ? void 0 : _row$attributes5.product.data.attributes[`unit_${index}_dp3`];
      }
    }
  ...
  const formatDate = data => {
    ...
    const date = new Date(data === null || data === void 0 ? void 0 : (_data$attributes = data.attributes) === null || _data$attributes === void 0 ? void 0 : _data$attributes.expired_date);
    var NewDate = external_moment_(date, "DD-MM-YYYY").format();
  ...
  const columns = [{
    ...
    selector: row => {
      ...
      return `${(_row$attributes8 = row.attributes) === null || _row$attributes8 === void 0 ? void 0 : _row$attributes8.total_order} ${(_row$attributes9 = row.attributes) === null || _row$attributes9 === void 0 ? void 0 : _row$attributes9.unit_order}`;
    }
  }, {
...
// CONCATENATED MODULE: ./pages/dashboard/pembelian/pembelian_barang/pembayaran/[id].js
...
function Pembayaran({
  ...
  const dataTable = props.purchases.data.attributes.purchasing_details;
  ...
  const statusPembayaran = props.purchases.data.attributes.status_pembayaran; // SUPPLIER INFO
  ...
  const onFinish = async values => {
    setLoading(true);
    var isValid = true; // checking payment method
  ...
  const createPayment = async values => {
    ...
    var newDate = external_moment_["utc"](date).utcOffset(7 * 60).format();
  ...
  const setPaymentStatus = async (data, paymentId) => {
    ...
    var list = [];
    data.purchasing_details.data.forEach(element => {
      list.push({
        id: element.id
      });
    });
            ...
            children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("div", {
              ...
              children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(row_default.a, {
                ...
                children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
                  ...
                  children: statusPembayaran === "Belum Lunas" ? /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      ...
                      children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(form_default.a.Item, {
                        ...
                        children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(select_default.a, {
                          ...
                          children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(select_default.a.Option, {
                            value: "Bank 1",
                            children: "Bank 1"
                          }, "Bank 1"), /*#__PURE__*/Object(jsx_runtime_["jsx"])(select_default.a.Option, {
                            value: "Bank 2",
                            children: "Bank 2"
                          }, "Bank 2"), /*#__PURE__*/Object(jsx_runtime_["jsx"])(select_default.a.Option, {
                            value: "Bank 3",
                            children: "Bank 3"
                          }, "Bank 3"), /*#__PURE__*/Object(jsx_runtime_["jsx"])(select_default.a.Option, {
                            value: "Cash On Delivery",
                            children: "Cash On Delivery"
                          }, "Cash On Delivery"), /*#__PURE__*/Object(jsx_runtime_["jsx"])(select_default.a.Option, {
              ...
              children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                ...
                return /*#__PURE__*/Object(jsx_runtime_["jsx"])(collapse_default.a, {
                  accordion: true,
                  children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Panel, {
                    header: date,
                    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      children: `Pembayaran 1 : ${formatter.format(element.attributes.payment_value_1)} (${element.attributes.payment_method_1})`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      children: `Pembayaran 2 : ${formatter.format(element.attributes.payment_value_2)} (${(_element$attributes$p = element.attributes.payment_method_2) !== null && _element$attributes$p !== void 0 ? _element$attributes$p : "-"})`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      children: `Pembayaran 3 : ${formatter.format(element.attributes.payment_value_3)} (${(_element$attributes$p2 = element.attributes.payment_method_3) !== null && _element$attributes$p2 !== void 0 ? _element$attributes$p2 : "-"})`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      className: "font-bold pt-5",
                      children: `Pembayaran : ${formatter.format(element.attributes.payment)}`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      className: "font-bold",
                      children: `Total Pembayaran : ${formatter.format(element.attributes.total_payment)}`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      className: "font-bold",
                      children: `Sisa Pembayaran : ${formatter.format(element.attributes.payment_remaining)}`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      className: "font-bold",
                      children: `Kembalian : ${formatter.format(element.attributes.change)}`
                    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
                      className: "pt-5 italic",
                      children: `Catatan : ${(_element$attributes$a = element.attributes.additional_note) !== null && _element$attributes$a !== void 0 ? _element$attributes$a : "-"}`
                    })]
                  }, date)
                });
              })]
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Pembayaran);
...
module.exports = __webpack_require__("0Ay4");
