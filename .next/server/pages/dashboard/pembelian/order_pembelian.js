...
module.exports = __webpack_require__("ovxt");
...
// CONCATENATED MODULE: ./components/ReactDataTable/Purchases/PurchasesOrderTable.js
...
function ReactDataTable({
  ...
  const columns = [{
    ...
    name: /*#__PURE__*/Object(jsx_runtime_["jsx"])("div", {
      className: "ml-6",
      children: "Status"
    }),
    width: "150px",
    selector: row => {
      return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(select_default.a, {
...
// CONCATENATED MODULE: ./pages/dashboard/pembelian/order_pembelian/index.js
...
Pembelian.getInitialProps = async context => {
  ...
  let data;
  const req = await order_pembelian_fetchData(cookies);
  data = await req.json();
  return {
    props: {
      data
...
/* harmony default export */ var order_pembelian = __webpack_exports__["default"] = (Pembelian);
