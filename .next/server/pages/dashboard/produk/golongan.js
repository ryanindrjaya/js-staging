...
module.exports = __webpack_require__("bVc7");
...
// CONCATENATED MODULE: ./components/ReactDataTable/GroupTable.js
...
function ReactDataTable({
  ...
  const columns = [{
    ...
    selector: row => {
      ...
      return (_row$attributes = row.attributes) === null || _row$attributes === void 0 ? void 0 : _row$attributes.code;
    }
  }, {
    name: "Nama Pabrikasi",
    width: "250px",
    ...
    sortable: true,
    selector: row => {
      var _row$attributes$alias, _row$attributes3;

      return (_row$attributes$alias = (_row$attributes3 = row.attributes) === null || _row$attributes3 === void 0 ? void 0 : _row$attributes3.alias) !== null && _row$attributes$alias !== void 0 ? _row$attributes$alias : "-";
    }
  }, {
    name: "Deskripsi",
    width: "250px",
    sortable: true,
    selector: row => {
      var _row$attributes$descr, _row$attributes4;

      return (_row$attributes$descr = (_row$attributes4 = row.attributes) === null || _row$attributes4 === void 0 ? void 0 : _row$attributes4.description) !== null && _row$attributes$descr !== void 0 ? _row$attributes$descr : "-";
    }
  }, {
    name: "Tindakan",
    width: "250px",
...
// CONCATENATED MODULE: ./pages/dashboard/produk/golongan/index.js
...
const Golongan = ({
  ...
  const handleDelete = async id => {
    ...
    if (res) {
      ...
      const res = await req.json();
      external_react_toastify_["toast"].success("Data berhasil dihapus");
      setGroup(res);
    }
  };
    ...
    try {
      ...
      if (res) {
        setGroup(prevData => {
          ...
          return {
            data: filterDuplicateData((_prevData$data = prevData.data) === null || _prevData$data === void 0 ? void 0 : _prevData$data.concat(res.data)),
            meta: prevData.meta
          };
        });
      } else {
...
Golongan.getInitialProps = async context => {
...
/* harmony default export */ var golongan = __webpack_exports__["default"] = (Golongan);
