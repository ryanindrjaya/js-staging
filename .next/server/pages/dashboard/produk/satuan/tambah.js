...
module.exports = __webpack_require__("GWF6");
...
const Tambah = () => {
  ...
  const onFinish = async values => {
    ...
    if (req.status === 200) {
      form.resetFields();
      react_toastify__WEBPACK_IMPORTED_MODULE_9__["toast"].success("Satuan berhasil ditambahkan!", {
        position: react_toastify__WEBPACK_IMPORTED_MODULE_9__["toast"].POSITION.TOP_RIGHT
      });
    } else {
      react_toastify__WEBPACK_IMPORTED_MODULE_9__["toast"].error("Tidak dapat menambahkan Satuan", {
        position: react_toastify__WEBPACK_IMPORTED_MODULE_9__["toast"].POSITION.TOP_RIGHT
      });
    }
