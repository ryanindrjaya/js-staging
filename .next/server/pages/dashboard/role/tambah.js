...
module.exports = __webpack_require__("GHZJ");
...
const Tambah = () => {
  ...
  const onFinish = async values => {
    ...
    if (req.status === 200) {
      form.resetFields();
      react_toastify__WEBPACK_IMPORTED_MODULE_11__["toast"].success("Role berhasil ditambahkan!", {
        position: react_toastify__WEBPACK_IMPORTED_MODULE_11__["toast"].POSITION.TOP_RIGHT
      });
    } else {
      react_toastify__WEBPACK_IMPORTED_MODULE_11__["toast"].error("Tidak dapat menambahkan Role baru", {
        position: react_toastify__WEBPACK_IMPORTED_MODULE_11__["toast"].POSITION.TOP_RIGHT
      });
    }
