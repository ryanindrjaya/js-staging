...
import { InputNumber, Select, Form, Row, DatePicker, Input } from "antd";
import { useDispatch } from "react-redux";

export default function ReactDataTable({ calculatePriceAfterDisc, productSubTotal, products, setTotalPrice, locations }) {
    const dispatch = useDispatch();
    //console.log("product LPB :"); console.log(products)
    var defaultDp1 = 0;
    var defaultDp2 = 0;
    var defaultDp3 = 0;
