export default function setHargaValue(
  ...
  if (unit == "1") {
    ...
    const hargaJual_unit2 = Number.parseFloat(
      hargaJual_unit1 / qty_unit2
    ).toFixed(2);
    ...
    const hargaJual_unit3 = Number.parseFloat(
      hargaJual_unit2 / qty_unit3
    ).toFixed(2);
    ...
    const hargaJual_unit4 = Number.parseFloat(
      hargaJual_unit3 / qty_unit4
    ).toFixed(2);
    ...
    const hargaJual_unit5 = Number.parseFloat(
      hargaJual_unit4 / qty_unit5
    ).toFixed(2);
  ...
  if (unit == "2") {
    ...
    if (qty_unit2) {
      form.setFieldsValue({
        buy_price_2: hargaPembelian_unit2,
        purchase_discount_2: diskonPembelian_unit2,
        sold_price_2: changedValues.sold_price_2 ?? hargaJual_unit2,
        pricelist_2: hargaPricelist_unit2,
      });
    }
    ...
    const hargaJual_unit3 =
      ...
      Number.parseFloat(hargaJual_unit2 / qty_unit3).toFixed(2);

    console.log("harga jual 3", changedValues);
    ...
    const hargaJual_unit4 =
      ...
      Number.parseFloat(hargaJual_unit3 / qty_unit4).toFixed(2);
    ...
    const hargaPricelist_unit5 = hargaPricelist_unit4 / qty_unit5;
    const hargaJual_unit5 =
      changedValues.sold_price_5 ??
      Number.parseFloat(hargaJual_unit4 / qty_unit5).toFixed(2);
