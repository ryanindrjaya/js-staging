...
export default function DownloadButton({ data, currentTime }) {
  const csvData = [
    ...
    ["Kas Besar", data.kas.previousPeriode.kasBesar, data.kas.currentPeriode.kasBesar, data.kas.coa.kasBesar],
    ["Kas Kecil", data.kas.previousPeriode.kasKecil, data.kas.currentPeriode.kasKecil, data.kas.coa.kasKecil],
    [
      "Kas Kecil Sejati",
    ...
    ["Kas E", data.kas.previousPeriode.kasE, data.kas.currentPeriode.kasE, data.kas.coa.kasE],
    [
    ...
    ["Bank", data.kas.previousPeriode.bank, data.kas.currentPeriode.bank, data.kas.coa.bank],
    [
      "Bank BCA Transfer",
    ...
    ["Bank BCA", data.kas.previousPeriode.bankBCA, data.kas.currentPeriode.bankBCA, data.kas.coa.bankBCA],
    [
      "Bank Mandiri",
    ...
    ["Bank Niaga", data.kas.previousPeriode.bankNiaga, data.kas.currentPeriode.bankNiaga, data.kas.coa.bankNiaga],
    ["Jumlah Kas dan Setara Kas", data.kas.previousPeriode.total, data.kas.currentPeriode.total],
    [],
    ["Piutang Usaha"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Piutang", data.piutang.previousPeriode.total, data.piutang.currentPeriode.total],
    [],
    ["Piutang Lain-lain"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Piutang", data.piutangLainnya.previousPeriode.total, data.piutangLainnya.currentPeriode.total],
    [],
    ["Persediaan"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Persediaan", data.persediaan.previousPeriode.total, data.persediaan.currentPeriode.total],
    [],
    ["Uang Muka Pajak"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Uang Muka Pajak", data.pajak.previousPeriode.total, data.pajak.currentPeriode.total],
    [],
    ...
    ["Jumlah Uang Muka", data.uangMuka.previousPeriode.total, data.uangMuka.currentPeriode.total],
    [],
    ["Aktiva Tetap"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    ["a. Harga Perolehan"],
    ...
    ["Jumlah Hutang Usaha", data.hutangUsaha.previousPeriode.total, data.hutangUsaha.currentPeriode.total],
    [],
    ...
    ["Jumlah Hutang Bank", data.hutangBank.previousPeriode.total, data.hutangBank.currentPeriode.total],
    [],
    ["Hutang Pajak"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Hutang Pajak", data.hutangPajak.previousPeriode.total, data.hutangPajak.currentPeriode.total],
    [],
    ["Hutang Lain-lain"],
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    [
    ...
    ["Jumlah Hutang Lain-lain", data.hutangLain.previousPeriode.total, data.hutangLain.currentPeriode.total],
    [
    ...
    ["Keterangan", "Periode Sebelumnya", "Periode Sekarang", "COA"],
    ["a. Modal"],
    ["Modal", data.modal.previousPeriode.modal, data.modal.currentPeriode.modal, data.modal.coa.modal],
    ["Total Modal", data.modal.previousPeriode.total, data.modal.currentPeriode.total],
    [],
    ["b. Retained Earning"],
    [
    ...
    ["Total Retained Earning", data.retainedEarning.previousPeriode.total, data.retainedEarning.currentPeriode.total],
    [],
