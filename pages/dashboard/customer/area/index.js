...
const fetchData = async (cookies) => {
  const endpoint = process.env.NEXT_PUBLIC_URL + "/areas?populate=*";
  const options = {
    method: "GET",
    headers: {
...
function Customer({ props }) {
  ...
  const handleAdd = (e) => {
    router.push("/dashboard/customer/area/tambah");
  };

  const handleUpdate = async (id) => {
    router.push("/dashboard/customer/area/edit/" + id);
  };
