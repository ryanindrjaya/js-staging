...
const Edit = ({ props }) => {
  ...
  return (
    <>
      ...
      <DashboardLayout>
        <LayoutWrapper style={{}}>
          <TitlePage titleText={"Edit Wilayah"} />
          <LayoutContent>
            <Form form={form} name="add_wilayah" onFinish={onFinish} initialValues={attributes}>
              <div className="flex flex-col md:flex-row gap-x-10">
                ...
                >
                  <Input onInput={(e) => (e.target.value = e.target.value.toUpperCase())} placeholder="Kode Wilayah" />
                </Form.Item>
                <Form.Item
                  className="w-full"
                  name="name"
                ...
                >
                  <Input onInput={(e) => (e.target.value = e.target.value.toUpperCase())} placeholder="Nama Wilayah" />
                </Form.Item>
              </div>
