...
export async function createInventoryFromReturPenjualan(row) {
  ...
  const retur_store_sale_details =
    returStoreSale.data.attributes.retur_store_sale_details.data;
  const no_retur_store_sale =
    returStoreSale.data.attributes.no_retur_store_sale;
